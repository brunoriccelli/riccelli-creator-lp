...
const forYou = [
  'Você está em transição do CLT para o mercado independente',
...
const notForYou = [
  'Você quer apenas um logo, sem trabalhar o posicionamento da marca',
  'Você ainda não sabe para quem quer vender seu serviço',
  'Você quer resultado sem passar pelo processo de posicionamento',
  'Você busca um resultado pontual, não uma identidade completa',
]
