...
export default function CTAFooter() {
  return (
    <section id='aplicar' className='py-20 sm:py-32 px-4 sm:px-6 bg-gradient-to-br from-brand via-brand/80 to-background relative overflow-hidden'>
      ...
      <div className='max-w-5xl mx-auto text-center relative z-10'>
        <motion.h2 
          ...
          className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-8 sm:mb-12 leading-tight px-4'
        >
        ...
        <motion.p
          ...
          className='text-base sm:text-lg md:text-xl text-textSecondary mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-4'
        >
      ...
      <footer id='contato' className='mt-16 sm:mt-24 pt-8 sm:pt-12 border-t border-white/10 relative z-10'>
