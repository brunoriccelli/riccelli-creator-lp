    ...
    <section className="py-24 px-6 bg-surface">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.p
          ...
          className="text-center text-textSecondary text-xl mb-16"
        >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-background border-2 border-brand/30 rounded-2xl p-8 hover:border-accent transition-all duration-300 h-full">
